	...
	public static List<ItemStack> getItems(){
		...
		for(int i = 0; i < randomAmmount; i++) {
			...
			if(choice == 0) {
				...
				items.add(new ItemStack(Material.WEB, randor.nextInt(4)+1));
			}
			else if(choice == 3) {
				...
				items.add(new ItemStack(Material.LOG, randor.nextInt(7)+1));
			}
			else if(choice == 6) {
				...
				items.add(new ItemStack(Material.SAPLING, randor.nextInt(2)+1));
			}
			else if(choice == 10) {
				items.add(new ItemStack(Material.COAL, randor.nextInt(3)+1));
			}
			else if(choice == 11) {
				items.add(new ItemStack(Material.RAW_BEEF, randor.nextInt(3)+1));
			}
			else if(choice == 12) {
				items.add(new ItemStack(Material.APPLE, randor.nextInt(3)+1));
			}
			else if(choice == 13) {
				items.add(new ItemStack(Material.RAW_CHICKEN, randor.nextInt(3)+1));
			}
			else if(choice == 14) {
				items.add(new ItemStack(Material.WOOL, randor.nextInt(3)+1));
			}
			else if(choice == 15) {
